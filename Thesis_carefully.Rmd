...
```{r}
#204 obs, I have 2 Indonesias, I will have to filter out one. 
table(second_join$unicef_country)
```
```{r}
#We have 2 indonesias and 3 NAs
table(second_join$unicef_country)
 second_join %>% 
...
I only gathered the information about these controls for the countries that I have for the indevpendent variable.
```{r}
library(readxl)
