...
```{r}
school_q_d<- read_sav("SCH/CY07_MSU_SCH_QQQ.sav")
```

__Filtering to include only public schools__
```{r}
school_q_d <- school_q_d %>% 
  filter(SC013Q01TA==1)
```
...
## Step 1: Instead of recoding all NAs for 0, we will filter them out

```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(RATCMP1))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(RATCMP2))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC155Q01HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC155Q02HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC155Q03HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC155Q04HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC155Q05HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC155Q06HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC155Q07HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC155Q08HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC155Q09HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC155Q10HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC155Q11HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC156Q01HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC156Q02HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC156Q03HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC156Q04HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC156Q05HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC156Q06HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC156Q07HA))
```
```{r}
school_q_d<-school_q_d %>% 
  filter(!is.na(SC156Q08HA))
```

```{r}
school_data<-school_q_d
```
...
```{r}
school_data$SC155Q01HA[school_data$SC155Q01HA==2]<- 0
school_data$SC155Q01HA[school_data$SC155Q01HA==1]<- 0
school_data$SC155Q01HA[school_data$SC155Q01HA==3]<-1
school_data$SC155Q01HA[school_data$SC155Q01HA==4]<-2
```
```{r}
school_data$SC155Q02HA[school_data$SC155Q02HA==2]<- 0
school_data$SC155Q02HA[school_data$SC155Q02HA==1]<- 0
school_data$SC155Q02HA[school_data$SC155Q02HA==3]<-1
school_data$SC155Q02HA[school_data$SC155Q02HA==4]<-2
```
```{r}
school_data$SC155Q03HA[school_data$SC155Q03HA==2]<- 0
school_data$SC155Q03HA[school_data$SC155Q03HA==1]<- 0
school_data$SC155Q03HA[school_data$SC155Q03HA==3]<-1
school_data$SC155Q03HA[school_data$SC155Q03HA==4]<-2
```
```{r}
school_data$SC155Q04HA[school_data$SC155Q04HA==2]<- 0
school_data$SC155Q04HA[school_data$SC155Q04HA==1]<- 0
school_data$SC155Q04HA[school_data$SC155Q04HA==3]<-1
school_data$SC155Q04HA[school_data$SC155Q04HA==4]<-2
```
```{r}
school_data$SC155Q05HA[school_data$SC155Q05HA==2]<- 0
school_data$SC155Q05HA[school_data$SC155Q05HA==1]<- 0
school_data$SC155Q05HA[school_data$SC155Q05HA==3]<-1
school_data$SC155Q05HA[school_data$SC155Q05HA==4]<-2
```
```{r}
school_data$SC155Q06HA[school_data$SC155Q06HA==2]<- 0
school_data$SC155Q06HA[school_data$SC155Q06HA==1]<- 0
school_data$SC155Q06HA[school_data$SC155Q06HA==3]<-1
school_data$SC155Q06HA[school_data$SC155Q06HA==4]<-2
```
```{r}
school_data$SC155Q07HA[school_data$SC155Q07HA==2]<- 0
school_data$SC155Q07HA[school_data$SC155Q07HA==1]<- 0
school_data$SC155Q07HA[school_data$SC155Q07HA==3]<-1
school_data$SC155Q07HA[school_data$SC155Q07HA==4]<-2
```
```{r}
school_data$SC155Q08HA[school_data$SC155Q08HA==2]<- 0
school_data$SC155Q08HA[school_data$SC155Q08HA==1]<- 0
school_data$SC155Q08HA[school_data$SC155Q08HA==3]<-1
school_data$SC155Q08HA[school_data$SC155Q08HA==4]<-2
```
```{r}
school_data$SC155Q09HA[school_data$SC155Q09HA==2]<- 0
school_data$SC155Q09HA[school_data$SC155Q09HA==1]<- 0
school_data$SC155Q09HA[school_data$SC155Q09HA==3]<-1
school_data$SC155Q09HA[school_data$SC155Q09HA==4]<-2
```
```{r}
school_data$SC155Q10HA[school_data$SC155Q10HA==2]<- 0
school_data$SC155Q10HA[school_data$SC155Q10HA==1]<- 0
school_data$SC155Q10HA[school_data$SC155Q10HA==3]<-1
school_data$SC155Q10HA[school_data$SC155Q10HA==4]<-2
```
```{r}
school_data$SC155Q11HA[school_data$SC155Q11HA==2]<- 0
school_data$SC155Q11HA[school_data$SC155Q11HA==1]<- 0
...
school_data<-school_data %>% 
  group_by(country) %>% 
  mutate(avg_ICT_index = mean(ICT_index))
```

# Save data set 

```{r}
write.csv(school_data, "ICT_data_sch_4.csv")
```
